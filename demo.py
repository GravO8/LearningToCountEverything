...
with torch.no_grad():
    # 'extract_features' works for batches of pairs of image and boxes. The unsqueeze
    # is here called to treat the 'image' and 'boxes' variables as a batch of a
    # single element
    features = extract_features(resnet50_conv,
                                image.unsqueeze(0),
                                boxes.unsqueeze(0),
                                MAPS,
                                Scales)
